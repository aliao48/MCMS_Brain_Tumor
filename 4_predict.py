...
class BraTSTrainer(Trainer):
    ...
    def define_model_MCMS_mamba(self):
        from model_MCMS_mamba.MCMS_mamba import MCMS_mamba
        model = MCMS_mamba(in_chans=4,
                        out_chans=4,
                        depths=[2,2,2,2],
                        feat_size=[48, 96, 192, 384])
        
        model_path = "/home/logs/MCMS_mamba/model/final_model_0.9038.pt"
        ...
        save_path = "./prediction_results/MCMS_mamba"
    ...
    def validation_step(self, batch):
        ...
        model, predictor, save_path = self.define_model_MCMS_mamba()
